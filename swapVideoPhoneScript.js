...
if (mediaQueryCondition.matches) {
    var scroll_phone = document.querySelector("#transition-content");
    scroll_phone.scrollLeft = 100;
    scroll_phone.addEventListener("scroll", () => {
                    console.log("Scrolled!", scroll_phone.scrollLeft)
                    if(scroll_phone.scrollLeft >= 140) {
                    ...
                    else if(scroll_phone.scrollLeft <= 60) {
                        transition.classList.toggle('in-out');
